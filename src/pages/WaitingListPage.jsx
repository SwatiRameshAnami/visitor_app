...
export default function WaitingListPage({ visitors, onExit, onBack }) {
  ...
  return (
    <div className="relative w-full h-full flex flex-col overflow-hidden">
      ...
      <div className={`${showFeedback ? "blur-sm pointer-events-none" : ""}`}>
        ...
        <div className="relative z-20 flex items-center justify-between px-6 pt-5 pb-4">
          ...
          <div className="text-center">
            ...
            <p className="font-body text-xs mt-0.5"
              style={{ color: "#3D6BC0", opacity: 0.7 }}>
              {visitors.length === 0
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(255,104,41,0.25)"
            }}
          >
            <p
            ...
            <p
              ...
              style={{ color: "#3D6BC0", opacity: 0.6 }}
            >
              Waiting
            </p>
          </div>
          ...
          {visitors.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full gap-4">
              ...
              <p className="font-body text-lg"
                style={{ color: "#3D6BC0", opacity: 0.5 }}>
                No visitors waiting right now
              </p>

              <p className="font-body text-sm"
                style={{ color: "#3D6BC0", opacity: 0.3 }}>
                Visitors who check in will appear here
              </p>
...
function InfoChip({ icon, text }) {
  return (
    <span className="flex items-center gap-1 text-xs"
      style={{ color: "rgba(61,107,192,0.6)" }}>
      <span>{icon}</span>
      <span>{text}</span>
    </span>
  );
